...
void KinematicSprite::update(float dt)
{
	...
	//if you want to make the line just straight across the screen uncomment the next 2 lines
	...
	//s = (u +v)/2  * t -> our previous u is incorportated with the getPosition and as dt -> 0 u -> v  v+v/2*dt 
	setPosition(getPosition() + (u + velocity)*0.5f*dt);
